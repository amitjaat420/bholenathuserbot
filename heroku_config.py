...
class Var(object):
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1365889843").split())
    WHITELIST_USERS = set(int(x) for x in os.environ.get("WHITELIST_USERS", "1365889843").split())
    BLACKLIST_USERS = set(int(x) for x in os.environ.get("BLACKLIST_USERS", "").split())
    DEVLOPERS = set(int(x) for x in os.environ.get("DEVLOPERS", "1365889843").split())
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "1365889843").split())
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1036214699").split())
